...
// Verze s React Router integrací
            ...
            <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                        {user ? (
                            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto" ref={menuRef}>
                                {/* User button s dropdown */}
                                <button
                                    onClick={() => setShowUserMenu(!showUserMenu)}
                                    className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors flex-1 sm:flex-initial relative"
                                >
                                ...
                                {/* Dropdown menu */}
                                {showUserMenu && (
                                    <div className="absolute top-full mt-2 right-4 sm:right-auto bg-white rounded-xl shadow-xl border border-gray-200 py-2 min-w-[200px] z-50">
                                        <div className="px-4 py-2 border-b border-gray-100">
                                            <p className="text-sm text-gray-500">Přihlášen jako</p>
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-700 text-sm sm:text-base">Upravit profil</span>
                                        </button>
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-700 text-sm sm:text-base">Odhlásit se</span>
                                        </button>
                                        ...
                                        <div className="border-t border-gray-100 mt-1 pt-1">
                                            ...
                                            >
                                                ...
                                                <span className="text-red-600 text-sm sm:text-base">Smazat účet</span>
                                            </button>
                                        </div>
                                    </div>
                                )}
